# Home Assistant Add-on: NGINX Configurable Home Assistant SSL proxy

Sets up an SSL proxy with NGINX and redirects traffic from port 80 to 443. Works the same as the official add on but lets you configure the fallback certificate. 
